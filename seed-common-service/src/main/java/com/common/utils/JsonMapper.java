...
public class JsonMapper {
	...
	public static void defaultPrintPretty(Object object) {
		try {
			System.out.println(defaultMapper().objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(object));
		} catch (IOException e) {
			throw new RuntimeException(e);
		}
	}
